...
scale_fill_gradientn(
  ...
  labs(
    title = "Hospital admission rate of foreign nationals in Brazil’s \n Unified Health System (SUS),  per 100,000 inhabitants (2019–Aug 2025)",
    subtitle = "Top 3 municipalities with highest rates",
    fill = "Rate",
...
ggsave("mapa_estrangeiros_taxa_en.png", width = 10, height = 6, dpi = 300)