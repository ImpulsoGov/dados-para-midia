...
dados_com_urgencia_2025$saude_mental_100k <- (dados_com_urgencia_2025$`Saúde mental` / dados_com_urgencia_2025$dependentes_do_sus) * 100000
dados_sem_urgencia_2025$saude_mental_100k <- (dados_sem_urgencia_2025$`Saúde mental` / dados_sem_urgencia_2025$dependentes_do_sus) * 100000
...
ggsave("../resultados/mapa_saude_mental_2025_comparativo.png",
       plot = mapa_combinado,
