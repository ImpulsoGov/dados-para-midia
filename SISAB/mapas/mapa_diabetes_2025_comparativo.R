...
dados_com_urgencia_2025$diabetes_100k <- (dados_com_urgencia_2025$Diabetes / dados_com_urgencia_2025$dependentes_do_sus) * 100000
dados_sem_urgencia_2025$diabetes_100k <- (dados_sem_urgencia_2025$Diabetes / dados_sem_urgencia_2025$dependentes_do_sus) * 100000
...
ggsave("../resultados/mapa_diabetes_2025_comparativo.png",
       plot = mapa_combinado,
