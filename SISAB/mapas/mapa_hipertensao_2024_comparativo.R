...
dados_com_urgencia_2024$hipertensao_100k <- (dados_com_urgencia_2024$`Hipertensão arterial` / dados_com_urgencia_2024$dependentes_do_sus) * 100000
dados_sem_urgencia_2024$hipertensao_100k <- (dados_sem_urgencia_2024$`Hipertensão arterial` / dados_sem_urgencia_2024$dependentes_do_sus) * 100000
...
ggsave("../resultados/mapa_hipertensao_2024_comparativo.png",
       plot = mapa_combinado,
