...
plt.tight_layout()
fig.suptitle('Distribuição de internações por UF dos 10 países com mais internações no período de 2019 a agosto de 2025', fontsize=16, y=0.98)
plt.subplots_adjust(top=0.88, bottom=0.1, hspace=0.3)
fig.text(0.5, 0.02, 'Fonte: SIH/SUS - Sistema de Informações Hospitalares do SUS.', ha='center', fontsize=10)
plt.savefig('mapas_top10_grid.png', dpi=300, bbox_inches='tight')
print("Mapas salvos em mapas_top10_grid.png")